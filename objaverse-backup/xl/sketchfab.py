...
class SketchfabDownloader(ObjaverseSource):
    ...
    def get_annotations(
        ...
        """
        remote_url = "https://hf-mirror.com/datasets/allenai/objaverse-xl/resolve/main/sketchfab/sketchfab.parquet"
    ...
    def _get_object_paths(cls, download_dir: str) -> Dict[str, str]:
        ...
        if not fs.exists(path):
            ...
            try:
                ...
                print(f"[HTTPError] {e.code} at {hf_url}")
                print("Error message:", e.reason)
                success = False
            except urllib.error.URLError as e:
                print(f"[URLError] at {hf_url}")
                print("Error message:", e.reason)
                success = False
            except Exception as e:
                print(f"[Other Exception] at {hf_url}")
                print("Error:", repr(e))
                success = False
                raise
    ...
    def _download_object(
        ...
        Args:
            ...
            hf_object_path: The path to the object in the Hugging Face repo. Here,
                ...
                repo url:
                https://hf-mirror.com/datasets/allenai/objaverse/resolve/main/{hf_object_path}
